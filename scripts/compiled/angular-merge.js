  ...
  'ngRoute'  ])
    ...
    .config(function($routeProvider, $locationProvider) {
        ...
        .when('/service', {
         ...
         .when('/journal', {
            templateUrl: 'templates/pages/journal-list.html',
            controller: 'mainController'
          })
          .when('/journal/:id', {
            templateUrl: 'templates/pages/journal-post.html',
          ...
          .when('/about', {
            templateUrl: 'templates/pages/biography.html'
          })
          .when('/music', {
...
//# sourceMappingURL=angular-merge.js.map
